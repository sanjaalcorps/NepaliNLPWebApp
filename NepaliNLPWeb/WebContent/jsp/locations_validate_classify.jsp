...
<title>NLP - Locations Validate and Classify</title>
	...
	<form action="/NepaliNLPWeb/LocationsValidationClassificationServlet" method="post">
		...
		<fieldset>
			...
			<div id="controlgroup_<%=word.getId()%>" class="class1">
				...
				<label for="word_location_<%=word.getId()%>">Yes</label> 
				<input type="checkbox" name="word_location_<%=word.getId()%>" id="word_location_<%=word.getId()%>" checked="checked">
