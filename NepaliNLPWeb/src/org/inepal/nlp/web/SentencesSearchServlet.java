...
public class SentencesSearchServlet extends AbstractNLPServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String searchType = request.getParameter("sentences_search_type");
		String searchLimit = request.getParameter("sentences_search_limit");
		
		System.out.println(searchQuery + " " + searchType + " " + searchLimit );
...
//	    	sentences.add(sentence2);
	    	...
	    	sentences = SentenceUnreferencedService.searchSentences(searchQuery, searchType, Integer.parseInt(searchLimit)); 
	    }
