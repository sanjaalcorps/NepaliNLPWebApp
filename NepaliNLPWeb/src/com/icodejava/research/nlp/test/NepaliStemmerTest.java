...
"मन्त्रीज्यूविरुद्ध"};*/
    ...
    public void test_get_verb_variations_negative_ending_in_unu() {
        String input = "रमाउनु";
        String output = NepaliStemmer.getNegativeVerbVariations(input).toString();
        String expected = "[नरमा, नरमाउनु, नरमाएको, नरमायेको, नरमाऊ, रमाएन, रमाएनौ, रमाइन, रमाएनछ, रमायेनछ, रमाएनन, रमायेनन, रमाईनन, रमाईनस, रमाईन, रमाइनन, रमाइनस, रमाइनछे, नरमाउनोस, नरमाउनुस, नरमाउनुहोस, रमाउनेछैन, रमाउनुहुनेछैन, रमाउनेछैनन, रमाउँदैनन, रमाउँदिनन, रमाउँदिन, रमाउँदिने, रमाउँदैन, रमाउनेछैनौ, रमाउनेछैनन, रमाउनेछैन, रमाउनुभएन]";
        Assert.assertThat(output, is(expected));
